...
(defpackage "COM.INFORMATIMAGO.OCLO"
  (:nicknames "OCLO")
  (:use "COMMON-LISP")
  (:export "*NULL*" "NULLP"))
...
(asdf:defsystem :mclgui-debug
  :name "mclgui-debug"
  :description "Macintosh Common Lisp Graphical User Interface for OpenStep - Debugging"
               ...
               #-(and) (
                        ...
                        (:file "mclgui"
                         :depends-on ("packages"
                                      ...
                                      "objc-classes"
                                      "point"
                                      "font" "pen" "pattern" "cursor" "view-stream"
  ...
  :perform (asdf:test-op
            ...
            (dolist (p '("MCLGUI"))
              (let ((*package* (find-package p)))
                #+asdf3 (progn
                          (uiop:symbol-call p "TEST/RECT")
                          (uiop:symbol-call p "TEST/REGION")
                          (uiop:symbol-call p "TEST/REGION-PATHS")
                          )))))
