...
(defpackage "MCLGUI.DEBUGGING"
  ...
  (:export "FORMAT-TRACE" "*MCLGUI-TRACE*" "*MCLGUI-PACKAGE*"
           ...
           "ALL-FUNCTIONS" "FIND-FUNCTION-FROM-ADDRESS"))
...
(defpackage "MCLGUI.SYSTEM"
  ...
  (:export
   "*LISP-CLEANUP-FUNCTIONS*" "*SAVE-EXIT-FUNCTIONS*"
   "*RESTORE-LISP-FUNCTIONS*" "*LISP-USER-POINTER-FUNCTIONS*"
   "*LISP-STARTUP-FUNCTIONS*" "*APPLICATION-SHOULD-TERMINATE-FUNCTIONS*"
   "*APPLICATION-DID-FINISH-LAUNCHING-FUNCTIONS*"
   "ON-LOAD-AND-NOW" "ON-QUIT" "ON-SAVE" "ON-RESTORE"
   "ON-APPLICATION-DID-FINISH-LAUNCHING"
   "ON-APPLICATION-SHOULD-TERMINATE" "ON-STARTUP"
   "WITHOUT-INTERRUPTS"
   "FIXNUMP" "ED-BEEP" "GET-SYS-JUST" "LIST-DESIGNATOR"
   "STANDARD-GENERIC-FUNCTION-P" "METHOD-EXISTS-P"))


(defpackage "MCLGUI.CIRCULAR"
  (:use "COMMON-LISP")
  (:export
...
(defpackage "MCLGUI.WRAPPER"
  ...
  (:export "ANONYMOUS-WRAPPER" "ANONYMOUS-WRAPPER-THUNK"
           ...
           "DO-NSDICTIONARY" "FLATTEN-CIRCULAR-REFERENCE" "HANDLE"
           "LIST-TO-NSARRAY" "MAKE-REFERENCE" "MAKE-REFERENCED"
           "MAP-NSARRAY" "NSARRAY-TO-LIST"
           "RECURSIVE-CIRCULAR-REGISTER" "RELEASE" "STRUCTURE"
           "UNWRAP" "UNWRAP-PLIST" "UNWRAPPING" "UPDATE-HANDLE"
           "WITH-HANDLE" "WRAP" "WRAP-RESOLVING-CIRCULAR-REFERENCES"
           "WRAPPER" "WRAPPING"))
...
(defpackage "MCLGUI"
  ...
  (:export
   ...
   "ON-APPLICATION-DID-FINISH-LAUNCHING"
   "ON-APPLICATION-SHOULD-TERMINATE"
   ...
   "COCOA-IDE-APPLICATION"; extension.
  ...
  (:export ;; EVENTS
   ...
   "APP1-EVT" "APP2-EVT" "APP3-EVT" "APP4-EVT" "EVERY-EVENT"
   "MOUSE-DOWN-MASK" "MOUSE-UP-MASK" "KEY-DOWN-MASK" "KEY-UP-MASK"
   "AUTO-KEY-MASK" "UPDATE-MASK" "DISK-MASK" "ACTIVATE-MASK"
   "NETWORK-MASK" "DRIVER-MASK" "APP1-MASK" "APP2-MASK" "APP3-MASK"
   "APP4-MASK" "ACTIVE-FLAG" "BTN-STATE" "CMD-KEY" "SHIFT-KEY"
   "ALPHA-LOCK" "OPTION-KEY"

   "POST-EVENT" "GET-NULL-EVENT" "EVENT-AVAIL"
   "GET-MOUSE" "BUTTON" "STILL-DOWN" "WAIT-MOUSE-UP"
   "GET-KEYS"
