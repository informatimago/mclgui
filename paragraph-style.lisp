...
(defstruct (paragraph-style (:conc-name ps-))
  ...
  (first-line-head-indent   0.0d0  :type cgfloat)
  (head-indent              0.0d0  :type cgfloat)
  (tail-indent              0.0d0  :type cgfloat)
  (hyphenation-factor       0.0f0  :type sfloat)
  (tightening-factor        0.05f0 :type sfloat)
  (line-height-multiple     0.0d0  :type cgfloat)
  (line-spacing             0.0d0  :type cgfloat)
  (maximum-line-height      0.0d0  :type cgfloat)
  (minimum-line-height      0.0d0  :type cgfloat)
  (paragraph-spacing        0.0d0  :type cgfloat)
  (paragraph-spacing-before 0.0d0  :type cgfloat)
  (default-tab-interval     8.0d0  :type cgfloat)
